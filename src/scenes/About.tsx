...
function About({setSelectedPage} : Props) {
  ...
  return (
    <section id='about' className='md:h-full py-10'>
        <div className="w-5/6 mx-auto md:h-full">
            <motion.div
            onViewportEnter={() => setSelectedPage(SelectedPage.Home)} className='md:flex gap-20'>
                {/* IMAGE */}
                ...
                >
                    ...
                    <p>I currently specialise in using Python and AWS Technologies to accelerate data processes along with being skilled at designing highly resilient and beautiful web pages.</p>
                </motion.div>
            </motion.div>
        </div>
    </section>
